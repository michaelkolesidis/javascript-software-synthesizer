...
import {
  hideSplashScreen,
  showSplashScreen,
} from './elements/splash/splashScreen.js';
...
(async () => {
  ...
  const render = await import('./elements/render.js').then(
    (module) => module.default
  );

  const enable = await import('./audio/webmidi.js').then(
    (module) => module.default
  );
  const audio = await import('./audio/audio.js').then(
    (module) => module.default
  );
