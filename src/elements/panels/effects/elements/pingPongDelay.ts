...
type PingPongDelayUIOptions = {
	[K in keyof Pick<PingPongDelayOptions, 'delayTime' | 'feedback'>]: CreateDialOptions;
};
...
function render() {
	const [wrapper, toggleWrapper, contentWrapper] = createEffectElements(id, 'Ping Pong Delay');
